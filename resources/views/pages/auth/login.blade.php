<x-app-layout pageTitle="Login">
                ...
                <div class="col-lg">
                    <div class="container-tight">
                        ...
                        <div class="card card-md">
                            <div class="card-body">
                                <h2 class="h2 text-center mb-4">Laravel Barebone</h2>
                                <form action="{{ route('auth.login') }}" method="POST" onsubmit="showLoader(event)">
                                    @csrf
                                    <div class="mb-3">
                                        <label class="form-label">NIP / Email</label>
                                        <input type="text" name="user_prefix" class="form-control @error('user_prefix') is-invalid is-invalid-lite @enderror"
                                            placeholder="NIP atau email anda" autocomplete="off" value="{{ old('user_prefix') }}">
                                        @error('user_prefix')
                                    ...
                                    <x-page-loader message="" sizeProgressBar="md"></x-page-loader>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        function showLoader(event) {
            ...
            document.getElementById('loginBtn').disabled = true; // Nonaktifkan tombol submit
            showLoading();
