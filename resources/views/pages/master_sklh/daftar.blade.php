                        ...
                        @foreach ($data as $dt)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endphp
                                    {{ $status[$dt->akun_diverifikasi] ?? '-' }}
                                </td>
                                <td>
                                    <a href="#" class="btn btn-success" style="line-height: 1; min-height: auto; height: auto;">
                                        <span class="mdi mdi-check-bold" style="font-size: 10px;"></span>
                                    </a>
                                </td>
                                <td>
                                    <a href="#" class="btn btn-danger" style="line-height: 1; min-height: auto; height: auto;">
                                        <span class="mdi mdi-close-thick" style="font-size: 10px;"></span>
                                    </a>
                                </td>
                                <td>
                                    <a href="#" class="btn btn-primary" style="line-height: 1; min-height: auto; height: auto;">
