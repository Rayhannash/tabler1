            ...
            <div class="row g-2 align-items-center">
                 <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-arrows breadcrumb-muted">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('nota_dinas.proposalselector') }}">Pilih Permohonan</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ route('nota_dinas.add', $rc->id) }}">Buat Nota Dinas</a>
                        </li>
                    </ol>
                </nav>
            </div>
