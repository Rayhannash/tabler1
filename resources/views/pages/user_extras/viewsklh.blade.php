<x-app-layout pageTitle="Detail Data">
    <div class="px-4 sm:px-6 lg:px-10">
        ...
        @if(Auth::user()->role_id == 2 && $dt->id_user == Auth::user()->id)
            <div class="space-y-4">
                {{-- Card dengan judul dan seluruh konten --}}
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title text-xl font-semibold">Detail Data</h3>

                        {{-- Tombol edit --}}
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="flex justify-end">
                                    <a class="btn btn-success text-white" href="{{ route('edit_data') }}">
                                        ...
                                        <dl>
                                            ...
                                            <dd class="mb-2">
                                                <div class="flex items-center gap-2">
                                                    <input type="text" class="form-control" value="{{ $dt->scan_surat_akreditasi_sklh }}" readonly>
                                                    <a href="{{ url('syst/storage/app/public/scan_surat_akreditasi_sklh/'.$dt->scan_surat_akreditasi_sklh) }}" class="btn btn-sm btn-primary" target="_blank">
                                                        Lihat File
                                                    </a>
                                                </div>
                                            </dd>
